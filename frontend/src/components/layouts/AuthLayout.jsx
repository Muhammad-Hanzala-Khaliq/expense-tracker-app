...
const AuthLayout = ({children}) => {
  return (
    <div className='flex' >
      ...
      <h2 className='text-lg font-medium text-black mt-[20px]'>Expense Tracker</h2>
      {children}
      </div>
      ...
      <div className='hidden md:block w-[40vw] h-screen bg-violet-50 bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative'>
        ...
        <img src={card} className='w-64 lg:w-[80%] absolute bottom-10 shadow-lg shadow-blue-400/15' alt="" />
      </div>
    </div>
  )
}
